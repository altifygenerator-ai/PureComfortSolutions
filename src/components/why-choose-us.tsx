        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <motion.p variants={fadeUp} className="mt-4 max-w-md">
              We take pride in doing the job right the first time — whether it’s
              heating and air, remodeling, or landscaping. No shortcuts, no
              guesswork, just dependable service you can trust for your home or property.
            </motion.p>
          ...
          >
            <img
              ...
              alt="HVAC and home service work"
